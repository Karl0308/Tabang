      ...
      <div className="App-header-app">
        <div className="App-header">
          <Form onSubmit={submitFormAdd} encType="multipart/form-data">
            ...
            <FormGroup className="ticket-form" style={{ fontSize: '18px' }}>
              <Label for="description" className="description-text">Assets :</Label>
              <AsyncSelect
                isMulti
                value={ticketAssets}
